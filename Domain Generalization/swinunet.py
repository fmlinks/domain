...
class SwinUNETR(nn.Module):
    ...
    def get_gradient(self):
        ...
        for param in self.parameters():
            if param.grad is not None:
                gradient.append(param.grad.view(-1))
        return gradient
    ...
    #     d2 = c_d + b + 1
    #
    #     # print(c_h, c_w, c_d, b, 'ccccccccccccccccccccccccccccccc')
    #     # print(h1, h2, w1, w2, d1, d2, 'aaaaaaaaaaaaaaaaaaaaaaaaaaa')
    #     # print(a_src.shape, 'a_src.shape 1')
    #     a_src = a_src[:, :, h1:h2, w1:w2, d1:d2]
    #     # print(a_src.shape, 'a_src.shape 2')
    #     a_src = np.fft.ifftshift(a_src, axes=(-3, -2, -1))
    #     # print(a_src.shape, 'a_src.shape 3')
    #     return a_src
    #
    ...
    def forward(self, x_in):
        ...
        latent = self.encoder3(hidden_states_out[1])  # [1, 24, 32, 32, 32]

        dec1 = self.decoder2(latent, enc1)     # latent4 [1, 24, 32, 32, 32], enc1 [1, 12, 64, 64, 64]
