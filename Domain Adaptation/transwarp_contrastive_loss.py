...
def transwarp_contrast_v1(latent_stu_S, latent_stu_T, latent_tea_S, latent_tea_T,
    ...
    positive3 = Similarity(gram_stu_T.view(gram_stu_T.size(0), -1), gram_tea_S.view(gram_tea_S.size(0), -1)).mean()
    negative3 = Similarity(gram_stu_S.view(gram_stu_S.size(0), -1), gram_tea_T.view(gram_tea_T.size(0), -1)).mean()

    contrast = - torch.log((positive1 + positive2 + positive3) /
                           (positive1 + positive2 + positive3 + negative1 + negative2 + negative3) * tao)

    print(positive1.item(), positive2.item(), negative1.item(), negative2.item(),
          'positive1, positive2, negative1, negative2')
    print(positive3.item(), negative3.item(),
          'positive3, negative3')

    # return contrast
    return contrast, positive1, positive2, positive3, negative1, negative2, negative3
...
def transwarp_contrast_v2(latent_stu_S, latent_stu_T, latent_tea_S, latent_tea_T,
    ...
    print(loss_positive1.item(), loss_positive2.item(), loss_negative1.item(), loss_negative2.item(),
          'positive1, positive2, negative1, negative2')
    print(loss_positive1.item(), loss_positive2.item(), loss_negative1.item(), loss_negative2.item(),
          'positive1, positive2, negative1, negative2')
    print(loss_positive3.item(), loss_negative3.item(),
          'positive3, negative3')
...
def transwarp_contrast(latent_stu_S, latent_stu_T, latent_tea_S, latent_tea_T,
    ...
    # positive5 = Similarity(gram_stu_T.view(gram_stu_T.size(0), -1), gram_tea_S.view(gram_tea_S.size(0), -1)).mean()
    # positive6 = Similarity(gram_stu_S.view(gram_stu_S.size(0), -1), gram_tea_T.view(gram_tea_T.size(0), -1)).mean()
    ...
    # train_33_04_ab3
    # contrast = - torch.log((positive1 + positive2 + positive3 + positive4) /
    #                        (positive1 + positive2 + positive3 + positive4 +
    #                         negative1 + negative2 + negative3 + negative4) * tao)
    ...
    # print(positive1.item(), positive2.item(), negative1.item(), negative2.item(),
    #       'positive1, positive2, negative1, negative2')
    # print(positive3.item(), positive4.item(), negative3.item(), negative4.item(),
    #       'positive3, positive4', 'negative3, negative4')
